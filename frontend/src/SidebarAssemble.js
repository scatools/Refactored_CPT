  ...
  return (
    <div>
                    ...
                    <Form.Group as={Row}>
                      <Col xs="9">
                        <RangeSlider
                          ...
                          onChange={(e) =>
                            handleWeights(e.target.value, "lcmr")
                          }
                          variant="secondary"
                        />
                      </Col>
                    ...
                    options={[
                      {
                        value: "hab1",
                        label:
                          "Padus - Connectivity to Existing Protected Area",
                      },
                ...
                <Button
                  ...
                  onClick={() => {
                    async function calculateNewData() {
                      ...
                      const scoreByGoal = calculateMeasures(
                        newAoiData,
                        weights
                      );
      ...
      <Modal show={show} onHide={handleClose} centered>
        ...
        <Modal.Body>
          Please make sure the sum of RESTORE Council Goals to be 100, at least
          1 data measure is selected and at least 2 area of interests selected.
        </Modal.Body>
        <Modal.Footer>
